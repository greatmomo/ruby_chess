...
describe Direction do
  describe '#direction_scan' do
    ...
    context 'both' do
      it 'returns two proper arrays' do
        expect(Direction.direction_scan(Direction.omni, Board.new, [2, 3], "white")[0]).to include(
          [1, 4],[0, 5],[3, 4],[4, 5],[3, 2],[1, 2])
        expect(Direction.direction_scan(Direction.omni, Board.new, [2, 3], "white")[1]).to include(
          [0, 1],[4, 1])
      end
    end
  end
